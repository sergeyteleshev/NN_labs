...
FILE_DIR = os.path.join(execution_path, "IdenProf-master/idenprof-jpg.zip")
DATASET_DIR = os.path.join(execution_path, "IdenProf-master/idenprof")
DATASET_TRAIN_DIR = os.path.join(DATASET_DIR, "IdenProf-master/train")
DATASET_TEST_DIR = os.path.join(DATASET_DIR, "IdenProf-master/test")
...
save_direc = os.path.join(os.getcwd(), 'IdenProf-master/idenprof_models')
...
def train_network():
    ...
    print(os.listdir(os.path.join(execution_path, "IdenProf-master/idenprof")))
...
JSON_PATH = os.path.join(execution_path, "IdenProf-master/idenprof_model_class.json")
